export var getRelativeParent = function getRelativeParent(element) {
  if (!element) {
    return null;
  }
...
*/
export var getSelectionRect = function getSelectionRect(selected) {
...
*/
export var getSelection = function getSelection(root) {
  var t = null;
...
*/
export var getSelectedBlockNode = function getSelectedBlockNode(root) {
